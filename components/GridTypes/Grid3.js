    ...
    return (
        <>
             <div style={{display:'flex',alignItems:'center'}}>
                <div className={styles.hoverCardTall} onClick={() => handleOpen(props.data[0])}>
                    <img src={props.data[0].src} style={{width:'100%'}} alt=""/>
                ...
                <div style={{display:'flex', flexDirection:'column'}}>
                    <div className={styles.hoverCard} onClick={() => handleOpen(props.data[1])}>
                                <img src={props.data[1].src} style={{width:'100%'}} alt=""/>
                    ...
                    <div className={styles.hoverCard} onClick={() => handleOpen(props.data[2])}>
                                <img src={props.data[2].src} style={{width:'100%'}} alt=""/>
                                <div className={styles.details}>
                                    <div>
            ...
            <div className={styles.hoverCard} onClick={() => handleOpen(props.data[3])}>
                <img src={props.data[3].src} style={{width:'100%'}} alt=""/>
                <div className={styles.details}>
                    <div>
            ...
            <div className={styles.hoverCard} onClick={() => handleOpen(props.data[4])}>
                <img src={props.data[4].src} style={{width:'100%'}} alt=""/>
                <div className={styles.details}>
                    <div>
            ...
            <div className={styles.hoverCard} onClick={() => handleOpen(props.data[5])}>
                <img src={props.data[5].src} style={{width:'100%'}} alt=""/>
                <div className={styles.details}>
                    <div>
